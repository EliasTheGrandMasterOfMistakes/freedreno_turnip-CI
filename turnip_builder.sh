...
sdkver="31"
mesasrc="https://codeload.github.com/EliasTheGrandMasterOfMistakes/platform_external_mesa3d/zip/refs/heads/turnip-build-new"
clear
...
prepare_workdir(){
	...
	unzip mesa-main.zip &> /dev/null
 	mv platform_external_mesa3d-turnip-build-new mesa-main
	cd mesa-main
}
